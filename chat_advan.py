...
def serve_fasthtml():
    ...
    async def ws(msg: str, send):
        ...
        system_prompt = (
            ...
            "Review provided context information for guidance. Do not mntion conversation history directly. Avoid pronouns where possible."
            "Introduce yourself as Agony Aunt, elaborate in detail using context if needed."
        )
